...
import { isObjectPattern } from '../helpers/ast-helper';
import { isIdentifierPropertyPair, isStoreToRefsDeclaration } from '../helpers/function-checks';
 ...
 */
export const storeStateSuffix = createEslintRule({
